...
export default function SearchBar({
    ...
    return (
        <div ref={searchRef} className={`relative ${className}`}>
            {/* Search Input */}
            <div className={`
                bg-white border-3 border-black rounded-2xl px-4 py-2
                transition-all duration-200
                ${isFocused
                    ? 'shadow-none translate-x-[2px] translate-y-[2px] bg-pop-mint'
                    : 'shadow-neo hover:shadow-neo-lg hover:-translate-x-1 hover:-translate-y-1'
                }
            `}>
                <div className="relative">
                    ...
                    <input
                        ref={inputRef}
                        type="text"
                        className="w-full pl-10 pr-4 py-2 bg-transparent text-black placeholder-black/50 focus:outline-none font-bold italic text-lg"
